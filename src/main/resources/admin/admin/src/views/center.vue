    ...
    >
      <el-row>
        <el-form-item
            ...
            label="学生账号" prop="xueshengzhanghao">
        ...
        <el-form-item
            ...
            :style='{"padding":"2px 0","margin":"0 auto 24px","color":"inherit","borderRadius":"4px","background":"none","width":"100%","fontSize":"inherit"}'
            label="班级" prop="banji">
          <el-input v-model="ruleForm.banji" clearable placeholder="班级"></el-input>
        </el-form-item>
        <el-form-item
            v-if="flag=='xuesheng'"
            :style='{"padding":"2px 0","margin":"0 auto 24px","color":"inherit","borderRadius":"4px","background":"none","width":"100%","fontSize":"inherit"}'
            label="手机号" prop="shoujihao">
          <el-input v-model="ruleForm.shoujihao" clearable placeholder="手机号"></el-input>
        </el-form-item>
        <el-form-item
            v-if="flag=='xuesheng'"
            :style='{"padding":"2px 0","margin":"0 auto 24px","color":"inherit","borderRadius":"4px","background":"none","width":"100%","fontSize":"inherit"}'
        ...
        <el-form-item
          ...
          <el-button
              :style='{"border":"0px solid #3fcbca","cursor":"pointer","padding":"0 20px","margin":"0px 4px","color":"#fff","clipPath":"polygon(5% 0, 100% 0%, 95% 100%, 0% 100%)","outline":"none","borderRadius":"10px","background":"#64ac56","width":"auto","fontSize":"18px","lineHeight":"24px","height":"40px"}'
              class="btn3"
