    ...
    >
      <template>
        <el-form-item
            ...
            class="input" label="用户名" prop="username">
          <el-input v-model="ruleForm.username" :readonly="ro.username" clearable placeholder="用户名"></el-input>
        </el-form-item>
        <el-form-item
            v-else
            :style='{"padding":"2px 0","margin":"0 auto 24px","color":"inherit","borderRadius":"4px","background":"none","width":"100%","fontSize":"inherit"}'
        ...
        <el-form-item
            v-if="type!='info'"
            :style='{"padding":"2px 0","margin":"0 auto 24px","color":"inherit","borderRadius":"4px","background":"none","width":"100%","fontSize":"inherit"}'
            class="input" label="密码" prop="password">
          <el-input v-model="ruleForm.password" :readonly="ro.password" clearable placeholder="密码"></el-input>
        </el-form-item>
        <el-form-item
            v-else
            :style='{"padding":"2px 0","margin":"0 auto 24px","color":"inherit","borderRadius":"4px","background":"none","width":"100%","fontSize":"inherit"}'
