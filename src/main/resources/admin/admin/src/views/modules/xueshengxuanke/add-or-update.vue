    ...
    >
      <template>
        ...
        <el-form-item
          ...
          <el-input v-model="ruleForm.kechengleixing" :readonly="ro.kechengleixing" clearable
                    placeholder="课程类型"></el-input>
        </el-form-item>
        <el-form-item
            v-else
            :style='{"padding":"2px 0","margin":"0 auto 24px","color":"inherit","borderRadius":"4px","background":"none","width":"100%","fontSize":"inherit"}'
        ...
        <el-form-item
            v-if="type!='info'"
            :style='{"padding":"2px 0","margin":"0 auto 24px","color":"inherit","borderRadius":"4px","background":"none","width":"100%","fontSize":"inherit"}'
            class="date" label="选课时间" prop="xuankeshijian">
          <el-date-picker
              v-model="ruleForm.xuankeshijian"
              :readonly="ro.xuankeshijian"
              placeholder="选课时间"
              type="datetime"
        ...
        <el-form-item
            v-else-if="ruleForm.xuankeshijian"
            :style='{"padding":"2px 0","margin":"0 auto 24px","color":"inherit","borderRadius":"4px","background":"none","width":"100%","fontSize":"inherit"}'
            class="input" label="选课时间" prop="xuankeshijian">
          <el-input v-model="ruleForm.xuankeshijian" placeholder="选课时间" readonly></el-input>
        </el-form-item>
        <el-form-item
            v-if="type!='info'"
            :style='{"padding":"2px 0","margin":"0 auto 24px","color":"inherit","borderRadius":"4px","background":"none","width":"100%","fontSize":"inherit"}'
...
export default {
  ...
  components: {},
  created() {
    this.ruleForm.xuankeshijian = this.getCurDateTime()
  },
  methods: {
            ...
            this.$http({
              ...
              if (data && data.code === 0) {
                if (data.data.total >= crossoptnum) {
                  ...
                  this.$http({
                    url: `xueshengxuanke/${!this.ruleForm.id ? "save" : "update"}`,
                    method: "post",
                    data: this.ruleForm
                  }).then(({data}) => {
                    if (data && data.code === 0) {
                      this.$message({
                        ...
                        onClose: () => {
                          ...
                          this.parent.xueshengxuankeCrossAddOrUpdateFlag = false;
                          this.parent.search();
