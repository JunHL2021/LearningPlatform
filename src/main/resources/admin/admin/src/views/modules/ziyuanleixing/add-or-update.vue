    ...
    >
      <template>
        <el-form-item
          ...
          <el-input v-model="ruleForm.ziyuanleixing" :readonly="ro.ziyuanleixing" clearable
        ...
        <el-form-item
            v-if="type!='info' && !ro.image"
            :style='{"padding":"2px 0","margin":"0 auto 24px","color":"inherit","borderRadius":"4px","background":"none","width":"100%","fontSize":"inherit"}'
            class="upload" label="图片" prop="image">
          <file-upload
        ...
        <el-form-item
            v-else-if="ruleForm.image"
            :style='{"padding":"2px 0","margin":"0 auto 24px","color":"inherit","borderRadius":"4px","background":"none","width":"100%","fontSize":"inherit"}'
            class="upload" label="图片" prop="image">
          <img v-if="ruleForm.image.substring(0,4)=='http'" v-bind:key="index" :src="ruleForm.image.split(',')[0]"
               class="upload-img" height="100" style="margin-right:20px;" width="100">
          <img v-for="(item,index) in ruleForm.image.split(',')" v-else v-bind:key="index" :src="$base.url+item"
               class="upload-img" height="100" style="margin-right:20px;" width="100">
        </el-form-item>
      </template>
      <el-form-item
            ...
            this.$http({
              ...
              if (data && data.code === 0) {
                if (data.data.total >= crossoptnum) {
                  ...
                  this.$http({
                    url: `ziyuanleixing/${!this.ruleForm.id ? "save" : "update"}`,
                    method: "post",
                    data: this.ruleForm
                  }).then(({data}) => {
                    if (data && data.code === 0) {
                      this.$message({
                        ...
                        onClose: () => {
                          ...
                          this.parent.ziyuanleixingCrossAddOrUpdateFlag = false;
                          this.parent.search();
