    ...
    >
      <template>
        ...
        <el-form-item
            v-if="type!='info'"
            :style='{"padding":"2px 0","margin":"0 auto 24px","color":"inherit","borderRadius":"4px","background":"none","width":"100%","fontSize":"inherit"}'
            class="input" label="密码" prop="mima">
          <el-input v-model="ruleForm.mima" :readonly="ro.mima" clearable placeholder="密码"></el-input>
        </el-form-item>
        <el-form-item
            v-else
            :style='{"padding":"2px 0","margin":"0 auto 24px","color":"inherit","borderRadius":"4px","background":"none","width":"100%","fontSize":"inherit"}'
        ...
        <el-form-item
            v-if="type!='info'"
            :style='{"padding":"2px 0","margin":"0 auto 24px","color":"inherit","borderRadius":"4px","background":"none","width":"100%","fontSize":"inherit"}'
            class="input" label="手机号" prop="shoujihao">
          <el-input v-model="ruleForm.shoujihao" :readonly="ro.shoujihao" clearable placeholder="手机号"></el-input>
        </el-form-item>
        <el-form-item
            v-else
            :style='{"padding":"2px 0","margin":"0 auto 24px","color":"inherit","borderRadius":"4px","background":"none","width":"100%","fontSize":"inherit"}'
        ...
        <el-form-item
            v-if="type!='info'"
            :style='{"padding":"2px 0","margin":"0 auto 24px","color":"inherit","borderRadius":"4px","background":"none","width":"100%","fontSize":"inherit"}'
            class="select" label="性别" prop="xingbie">
          <el-select v-model="ruleForm.xingbie" :disabled="ro.xingbie" placeholder="请选择性别">
            <el-option
        ...
        <el-form-item
            v-else
            :style='{"padding":"2px 0","margin":"0 auto 24px","color":"inherit","borderRadius":"4px","background":"none","width":"100%","fontSize":"inherit"}'
            class="input" label="性别" prop="xingbie">
        ...
        <el-form-item
            v-if="type!='info'"
            :style='{"padding":"2px 0","margin":"0 auto 24px","color":"inherit","borderRadius":"4px","background":"none","width":"100%","fontSize":"inherit"}'
            class="input" label="年龄" prop="nianling">
          <el-input v-model="ruleForm.nianling" :readonly="ro.nianling" clearable placeholder="年龄"></el-input>
        </el-form-item>
        <el-form-item
            v-else
            :style='{"padding":"2px 0","margin":"0 auto 24px","color":"inherit","borderRadius":"4px","background":"none","width":"100%","fontSize":"inherit"}'
        ...
        <el-form-item
          ...
          <img v-for="(item,index) in ruleForm.touxiang.split(',')" v-else v-bind:key="index" :src="$base.url+item"
               class="upload-img" height="100" style="margin-right:20px;" width="100">
        </el-form-item>
      </template>
      <el-form-item
