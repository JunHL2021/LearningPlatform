    ...
    >
      <template>
        ...
        <el-form-item
            v-if="type!='info'"
            :style='{"padding":"2px 0","margin":"0 auto 24px","color":"inherit","borderRadius":"4px","background":"none","width":"100%","fontSize":"inherit"}'
            class="date" label="布置时间" prop="buzhishijian">
          <el-date-picker
              v-model="ruleForm.buzhishijian"
              :readonly="ro.buzhishijian"
              placeholder="布置时间"
              type="datetime"
        ...
        <el-form-item
            v-else-if="ruleForm.buzhishijian"
            :style='{"padding":"2px 0","margin":"0 auto 24px","color":"inherit","borderRadius":"4px","background":"none","width":"100%","fontSize":"inherit"}'
            class="input" label="布置时间" prop="buzhishijian">
          <el-input v-model="ruleForm.buzhishijian" placeholder="布置时间" readonly></el-input>
        </el-form-item>
        <el-form-item
            v-if="type!='info'&& !ro.zuoyefujian"
            :style='{"padding":"2px 0","margin":"0 auto 24px","color":"inherit","borderRadius":"4px","background":"none","width":"100%","fontSize":"inherit"}'
            class="upload" label="作业附件" prop="zuoyefujian">
          <file-upload
              :fileUrls="ruleForm.zuoyefujian?ruleForm.zuoyefujian:''"
              :limit="1"
              :multiple="true"
              :type="3"
              action="file/upload"
              tip="点击上传作业附件"
              @change="zuoyefujianUploadChange"
          ></file-upload>
        </el-form-item>
        <el-form-item
            v-else-if="ruleForm.zuoyefujian"
            :style='{"padding":"2px 0","margin":"0 auto 24px","color":"inherit","borderRadius":"4px","background":"none","width":"100%","fontSize":"inherit"}'
            label="作业附件" prop="zuoyefujian">
          <el-button
              ...
              size="small" type="text" @click="download($base.url+ruleForm.zuoyefujian)">下载
          </el-button>
        </el-form-item>
        <el-form-item
            v-else-if="!ruleForm.zuoyefujian"
      ...
      <el-form-item
          v-if="type!='info'"
          :style='{"padding":"2px 0","margin":"0 auto 24px","color":"inherit","borderRadius":"4px","background":"none","width":"100%","fontSize":"inherit"}'
          class="textarea" label="作业要求" prop="zuoyeyaoqiu">
        <el-input
...
export default {
  ...
  components: {},
  created() {
    this.ruleForm.buzhishijian = this.getCurDateTime()
  },
  methods: {
    ...
    init(id, type) {
      ...
      if (this.type == 'info' || this.type == 'else') {
        ...
        for (var o in obj) {
          ...
          if (o == 'zuoyefujian') {
            this.ruleForm.zuoyefujian = obj[o];
            this.ro.zuoyefujian = true;
            continue;
          }
          if (o == 'jiaoshigonghao') {
    ...
    onSubmit() {
      ...
      if (this.ruleForm.zuoyefujian != null) {
        this.ruleForm.zuoyefujian = this.ruleForm.zuoyefujian.replace(new RegExp(this.$base.url, "g"), "");
      }
            ...
            this.$http({
              ...
              if (data && data.code === 0) {
                if (data.data.total >= crossoptnum) {
                  ...
                  this.$http({
                    url: `buzhizuoye/${!this.ruleForm.id ? "save" : "update"}`,
                    method: "post",
                    data: this.ruleForm
                  }).then(({data}) => {
                    if (data && data.code === 0) {
                      this.$message({
                        ...
                        onClose: () => {
                          ...
                          this.parent.buzhizuoyeCrossAddOrUpdateFlag = false;
                          this.parent.search();
    ...
    zuoyefujianUploadChange(fileUrls) {
      this.ruleForm.zuoyefujian = fileUrls;
    },
  }
};
</script>
