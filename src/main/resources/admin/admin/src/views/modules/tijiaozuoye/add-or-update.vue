    ...
    >
      <template>
        ...
        <el-form-item
            v-if="type!='info'"
            :style='{"padding":"2px 0","margin":"0 auto 24px","color":"inherit","borderRadius":"4px","background":"none","width":"100%","fontSize":"inherit"}'
            class="date" label="提交时间" prop="tijiaoshijian">
          <el-date-picker
        ...
        <el-form-item
            v-else-if="ruleForm.tijiaoshijian"
            :style='{"padding":"2px 0","margin":"0 auto 24px","color":"inherit","borderRadius":"4px","background":"none","width":"100%","fontSize":"inherit"}'
            class="input" label="提交时间" prop="tijiaoshijian">
        ...
        <el-form-item
            v-if="type!='info'&& !ro.zuoyeneirong"
            :style='{"padding":"2px 0","margin":"0 auto 24px","color":"inherit","borderRadius":"4px","background":"none","width":"100%","fontSize":"inherit"}'
            class="upload" label="作业内容" prop="zuoyeneirong">
          <file-upload
              :fileUrls="ruleForm.zuoyeneirong?ruleForm.zuoyeneirong:''"
              :limit="1"
              :multiple="true"
              :type="3"
              action="file/upload"
              tip="点击上传作业内容"
              @change="zuoyeneirongUploadChange"
          ></file-upload>
        </el-form-item>
        <el-form-item
            v-else-if="ruleForm.zuoyeneirong"
            :style='{"padding":"2px 0","margin":"0 auto 24px","color":"inherit","borderRadius":"4px","background":"none","width":"100%","fontSize":"inherit"}'
            label="作业内容" prop="zuoyeneirong">
          <el-button
              ...
              size="small" type="text" @click="download($base.url+ruleForm.zuoyeneirong)">下载
          </el-button>
        </el-form-item>
        <el-form-item
            v-else-if="!ruleForm.zuoyeneirong"
...
export default {
  ...
  methods: {
    ...
    onSubmit() {
      ...
      if (this.ruleForm.zuoyeneirong != null) {
        this.ruleForm.zuoyeneirong = this.ruleForm.zuoyeneirong.replace(new RegExp(this.$base.url, "g"), "");
      }
    ...
    zuoyeneirongUploadChange(fileUrls) {
      this.ruleForm.zuoyeneirong = fileUrls;
    },
  }
};
</script>
