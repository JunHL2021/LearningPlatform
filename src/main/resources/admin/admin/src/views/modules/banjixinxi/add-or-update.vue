    ...
    >
      <template>
        ...
        <el-form-item
            v-if="type!='info'"
            :style='{"padding":"2px 0","margin":"0 auto 24px","color":"inherit","borderRadius":"4px","background":"none","width":"100%","fontSize":"inherit"}'
            class="input" label="班级号" prop="banjihao">
          <el-input v-model="ruleForm.banjihao" :readonly="ro.banjihao" clearable placeholder="班级号"></el-input>
        </el-form-item>
        <el-form-item
            v-else
            :style='{"padding":"2px 0","margin":"0 auto 24px","color":"inherit","borderRadius":"4px","background":"none","width":"100%","fontSize":"inherit"}'
        ...
        <el-form-item
            v-if="type!='info'"
            :style='{"padding":"2px 0","margin":"0 auto 24px","color":"inherit","borderRadius":"4px","background":"none","width":"100%","fontSize":"inherit"}'
            class="input" label="班级名称" prop="banjimingcheng">
          <el-input v-model="ruleForm.banjimingcheng" :readonly="ro.banjimingcheng" clearable
        ...
        <el-form-item
            v-if="type!='info'"
            :style='{"padding":"2px 0","margin":"0 auto 24px","color":"inherit","borderRadius":"4px","background":"none","width":"100%","fontSize":"inherit"}'
            class="input" label="班级人数" prop="banjirenshu">
          <el-input v-model.number="ruleForm.banjirenshu" :readonly="ro.banjirenshu" clearable
        ...
        <el-form-item
            v-if="type!='info' && !ro.banjitupian"
            :style='{"padding":"2px 0","margin":"0 auto 24px","color":"inherit","borderRadius":"4px","background":"none","width":"100%","fontSize":"inherit"}'
            class="upload" label="班级图片" prop="banjitupian">
          <file-upload
        ...
        <el-form-item
            v-else-if="ruleForm.banjitupian"
            :style='{"padding":"2px 0","margin":"0 auto 24px","color":"inherit","borderRadius":"4px","background":"none","width":"100%","fontSize":"inherit"}'
            class="upload" label="班级图片" prop="banjitupian">
          <img v-if="ruleForm.banjitupian.substring(0,4)=='http'" v-bind:key="index"
               :src="ruleForm.banjitupian.split(',')[0]"
               class="upload-img" height="100" style="margin-right:20px;" width="100">
          <img v-for="(item,index) in ruleForm.banjitupian.split(',')" v-else v-bind:key="index" :src="$base.url+item"
               class="upload-img" height="100" style="margin-right:20px;" width="100">
        </el-form-item>
      </template>
      <el-form-item
    ...
    info(id) {
      this.$http({
        ...
        if (data && data.code === 0) {
          ...
          this.ruleForm.banjijieshao = this.ruleForm.banjijieshao.replace(reg, '../../../LearningPlatform/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
