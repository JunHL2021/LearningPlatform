<template>
  <div
      :style='{"minHeight":"calc(100vh - 200px)","padding":"30px","margin":"0 auto","alignItems":"flex-start","flexWrap":"wrap","textAlign":"center","background":"url(https://img.mp.sohu.com/upload/20170807/2c45b8e240b34510b85ad2bb0b3f5751_th.png) no-repeat center top / cover","display":"flex","width":"100%","fontSize":"16px","justifyContent":"center","height":"100%"}'
      class="content">
    <!-- notice -->
    <!-- title -->
    <div
        :style='{"padding":"10px 20px","margin":"0px auto 40px","borderColor":"#ceddee","color":"rgb(51, 51, 51)","borderRadius":"0px","textAlign":"center","background":"none","borderWidth":"0px","width":"100%","fontSize":"28px","borderStyle":"solid","fontWeight":"500"}'
        class="text">
  ...
  data() {
    return {
      line: {
        ...
        "series": {"showSymbol": true, "symbol": "emptyCircle", "symbolSize": 4},
        "tooltip": {"backgroundColor": "#fff", "textStyle": {"color": "#333"}},
        "title": {
          "borderType": "solid",
          "padding": 0,
          "shadowOffsetX": 0,
      ...
      bar: {
        ...
        "color": ["#00ff00", "#91cc75", "#fac858", "#ee6666", "#73c0de", "#3ba272", "#fc8452", "#9a60b4", "#ea7ccc"],
        "legend": {
          "padding": 0,
          "itemGap": 10,
          "shadowOffsetX": 0,
        ...
        "tooltip": {"backgroundColor": "#123", "textStyle": {"color": "#fff"}},
        "title": {
          "borderType": "solid",
          "padding": 0,
          "shadowOffsetX": 0,
      ...
      gauge: {
        ...
        "title": {
          "top": "top",
          "left": "left",
          "textStyle": {"fontSize": 14, "lineHeight": 24, "color": "#333", "fontWeight": 600}
        },
        "series": {
          "pointer": {
            "offsetCenter": [0, "10%"],
          ...
          "anchor": {"show": true, "itemStyle": {"color": "inherit"}, "size": 18, "showAbove": true},
          "emphasis": {"disabled": false},
          "progress": {"show": true, "roundCap": true, "overlap": true},
          "splitNumber": 25,
          "detail": {
            "formatter": "{value}",
      ...
      let wordcloud = {
        ...
        "option": {
          "tooltip": {"show": false}, "backgroundColor": "transparent", "series": [{
            ...
            "left": "center",
            "width": "80%",
            "emphasis": {"focus": "self", "textStyle": {"textShadowColor": "#333", "textShadowBlur": 0}},
            "drawOutOfBound": false,
            "rotationStep": 45,
            "textStyle": {
              "color": "function(){return\"rgb(\"+[Math.round(160*Math.random()),Math.round(160*Math.random()),Math.round(160*Math.random())].join(\",\")+\")\"}",
              "fontWeight": 500,
