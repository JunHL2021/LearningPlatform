<template>
  <el-dialog :visible.sync="visible" title="拍照上传" width="1065px">
    <div class="box">
      <video id="videoCamera" :height="videoHeight" :width="videoWidth" autoPlay class="canvas"></video>
      <canvas id="canvasCamera" :height="videoHeight" :width="videoWidth" class="canvas"></canvas>
    </div>
    <div slot="footer" style="display:flex">
      ...
      <el-button icon="el-icon-circle-close" size="small" @click="onCancel">
        完成
      </el-button>
    </div>
  </el-dialog>
