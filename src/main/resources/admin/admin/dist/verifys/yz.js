;(function (undefined) {
    ...
    RotateVerify.prototype = {
        ...
        initDom: function () {
            ...
            // console.log(this.$slideDragWrap.width(),this.$slideDragBtn.outerWidth(),this.aveRot)
        ...
        initMouse: function () {
            ...
            $(document).on('mouseup', function () {
                ...
                if (_this.sucLenMin <= _this.disLf && _this.disLf <= _this.sucLenMax) {
                    ...
                    _this.statusBg.addClass('icon-dagou');
                    ...
                    ;
                    _this.statusBg.fadeIn();
                    _this.statusBg.addClass('icon-guanbi1');
                    _this.$slideDragBtn.delay(700).animate({
                        ...
                        _this.statusBg.removeClass('icon-guanbi1');
        ...
        resetSlide: function () {
            ...
            _this.$slideDragWrap.removeClass('control-horizontal');
            _this.statusBg.fadeOut();
            _this.statusBg.removeClass('icon-dagou');
