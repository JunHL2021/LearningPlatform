    ...
    <view
      ...
      <form
        ...
        <view
          ...
          <input v-model="ruleForm.pingfenshijian"
                 :disabled="ro.pingfenshijian"
                 :style='{"border":"2rpx solid #fff","padding":"0px 24rpx","margin":"0px","color":"#666","borderRadius":"8rpx","flex":"1","background":"rgba(255,255,255,.6)","fontSize":"28rpx","height":"80rpx"}'
                 placeholder="评分时间" @tap="toggleTab('pingfenshijian')"></input>
        </view>
        <view
            :style='{"padding":"0px 24rpx","margin":"0 0 24rpx 0","borderColor":"#7D7D7D","alignItems":"center","borderWidth":"0 0 2rpx","display":"flex","width":"100%","borderStyle":"solid","height":"auto"}'
            class="">
        ...
        <view
          ...
          <input
              v-model="ruleForm.zuoyemingcheng"
              :disabled="ro.zuoyemingcheng"
              :style='{"border":"2rpx solid #fff","padding":"0px 24rpx","margin":"0px","color":"#666","borderRadius":"8rpx","flex":"1","background":"rgba(255,255,255,.6)","fontSize":"28rpx","height":"80rpx"}'
              placeholder="作业名称"
              type="text"></input>
        </view>
        <view
          ...
          <input
              ...
              :disabled="ro.chengji"
              :style='{"border":"2rpx solid #fff","padding":"0px 24rpx","margin":"0px","color":"#666","borderRadius":"8rpx","flex":"1","background":"rgba(255,255,255,.6)","fontSize":"28rpx","height":"80rpx"}'
              placeholder="成绩" type="text"></input>
        </view>
        <view
            :style='{"padding":"0px 24rpx","margin":"0 0 24rpx 0","borderColor":"#7D7D7D","alignItems":"center","borderWidth":"0 0 2rpx","display":"flex","width":"100%","borderStyle":"solid","height":"auto"}'
            class=" select">
        ...
        <view
          ...
          <textarea
              ...
              :style='{"border":"2rpx solid #fff","padding":"24rpx","margin":"0px","color":"#666","borderRadius":"8rpx","flex":"1","background":"rgba(255,255,255,.6)","fontSize":"28rpx","height":"360rpx"}'
              placeholder="评分内容"></textarea>
        </view>
      ...
      <w-picker ref="pingfenshijian" :current="false" :hasSecond="false" mode="dateTime" step="1"
                themeColor="#333333" @confirm="pingfenshijianConfirm"></w-picker>
    </view>
  </view>
</template>
...
export default {
  ...
  async onLoad(options) {
    this.ruleForm.pingfenshijian = this.$utils.getCurDateTime();
    ...
    if (options.id) {
      ...
      // 获取信息
      res = await this.$api.info(`zuoyepingfen`, this.ruleForm.id);
...
//跨表计算判断
      ...
      if (crossrefid && crossuserid) {
        ...
        let res = await this.$api.list(`zuoyepingfen`, params);
        if (res.data.total >= crossoptnum) {
          ...
          //跨表计算
          if (this.ruleForm.id) {
            await this.$api.update(`zuoyepingfen`, this.ruleForm);
          } else {
            await this.$api.add(`zuoyepingfen`, this.ruleForm);
          }
