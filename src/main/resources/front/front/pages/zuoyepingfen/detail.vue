...
export default {
  ...
  async onShow(options) {
    ...
    if (crossCleanType) {
      ...
      res = await this.$api.info('zuoyepingfen', this.id);
  ...
  methods: {
    ...
    async init(type = 1) {
      ...
      let res = await this.$api.info('zuoyepingfen', this.id);
      this.detail = res.data;
      ...
      if (type == 2) {
        ...
        await this.$api.update('zuoyepingfen', this.detail)
      }
    },
