...
export default {
  ...
  async onShow(options) {
    ...
    if (crossCleanType) {
      ...
      res = await this.$api.info('ziyuanleixing', this.id);
      this.detail = res.data;
      this.title = this.detail.ziyuanleixing
    }
  },
  destroyed: function () {
  ...
  methods: {
    ...
    async init(type = 1) {
      ...
      let res = await this.$api.info('ziyuanleixing', this.id);
      this.detail = res.data;

      this.title = this.detail.ziyuanleixing
      if (type == 2) {
        this.detail.discussnum++
        await this.$api.update('ziyuanleixing', this.detail)
      }
    },
