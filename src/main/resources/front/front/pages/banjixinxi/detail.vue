        ...
        <view
          ...
          <view
            ...
            <view
              ...
              <view
                  :style='{"padding":"0px","margin":"0px","color":"#666","textAlign":"left","flex":"1","width":"auto","lineHeight":"48rpx","fontSize":"28rpx"}'
                  class="text">{{ detail.banjimingcheng }}
              </view>
            </view>
            <view
                :style='{"padding":"4rpx 24rpx 8rpx","margin":"0 auto","borderColor":"#000","borderWidth":"0 2rpx","background":"#FFF7DF","display":"flex","width":"calc(100% - 48rpx)","borderStyle":"solid","height":"auto"}'
            ...
            <view
              ...
              <view
                  ...
                  class="rich-text">
                <rich-text :nodes="detail.banjijieshao"></rich-text>
              </view>
            </view>
...
export default {
  ...
  async onShow(options) {
    ...
    if (crossCleanType) {
      ...
      res = await this.$api.info('banjixinxi', this.id);
      this.detail = res.data;
      this.title = this.detail.banjihao
    }
  },
  destroyed: function () {
  ...
  methods: {
    ...
    async init(type = 1) {
      ...
      let res = await this.$api.info('banjixinxi', this.id);
      this.detail = res.data;

      this.title = this.detail.banjihao
      //修改富文本的图片样式
      this.detail.banjijieshao = this.detail.banjijieshao.replace(/img src/gi, "img style=\"width:100%;\" src");
      // 轮播图片
      this.swiperList = this.detail.banjitupian ? this.detail.banjitupian.split(",") : [];


      if (type == 2) {
        this.detail.discussnum++
        await this.$api.update('banjixinxi', this.detail)
      }
    },
