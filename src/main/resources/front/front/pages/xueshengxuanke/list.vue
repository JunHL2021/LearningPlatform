<template>
  ...
  <mescroll-uni :down="downOption" :up="upOption" @down="downCallback" @init="mescrollInit" @up="upCallback">
    <view class="content">
        ...
        <view
          ...
          <view
            ...
            <text
                ...
                class="icon iconfont "></text>
            <input
                v-model="searchForm.kechengleixing"
                :style='{"border":"0","padding":"8rpx 20rpx 8rpx 20rpx","color":"#666","borderRadius":"0","background":"none","width":"100%","lineHeight":"80rpx","fontSize":"28rpx","height":"80rpx"}'
                placeholder="课程类型" type="text"></input>
          </view>
          <view
              v-if="queryIndex==2"
              :style='{"margin":"0 0px","borderColor":"#ff9593","borderRadius":"0","flex":"1","background":"#fff","borderWidth":"0","lineHeight":"80rpx","position":"relative","borderStyle":"solid","height":"80rpx"}'
            ...
            <input
                ...
                :style='{"border":"0","padding":"8rpx 20rpx 8rpx 20rpx","color":"#666","borderRadius":"0","background":"none","width":"100%","lineHeight":"80rpx","fontSize":"28rpx","height":"80rpx"}'
                placeholder="教师姓名" type="text"></input>
          </view>
          <view
              v-if="queryIndex==3"
              :style='{"margin":"0 0px","borderColor":"#ff9593","borderRadius":"0","flex":"1","background":"#fff","borderWidth":"0","lineHeight":"80rpx","position":"relative","borderStyle":"solid","height":"80rpx"}'
        ...
        <view
          ...
          <view
            ...
            <view v-for="(product,index) in list" :key="index"
              ...
              <image
                  v-if="preHttp(product.kechengfengmian)"
                  :src="product.kechengfengmian.split(',')[0]"
              ...
              <view
                ...
                <view
                    v-if="(userid && isAuth('xueshengxuanke','修改')) || (!userid && isAuthFront('xueshengxuanke','修改'))"
                    :data-row="product"
                ...
                <view
                    v-if="(userid && isAuth('xueshengxuanke','删除')) || (!userid && isAuthFront('xueshengxuanke','删除'))"
                    :data-row="product"
      ...
      <button
          v-if="userid && isAuth('xueshengxuanke','新增')"
      ...
      <button
          v-if="!userid && isAuthFront('xueshengxuanke','新增')"
          :style='{"border":"0","boxShadow":"none","color":"#fff","bottom":"120rpx","right":"120rpx","borderRadius":"100%","background":"#0C77D5","width":"80rpx","lineHeight":"80rpx","fontSize":"28rpx","position":"absolute","height":"80rpx","zIndex":"999"}'
          class="add-btn" @click="onAddTap()">新增
      </button>
    </view>
...
export default {
  ...
  methods: {
    ...
    async upCallback(mescroll) {
      ...
      let res = {}
      if (this.userid) {
        res = await this.$api.page(`xueshengxuanke`, params);
      } else {
        res = await this.$api.list(`xueshengxuanke`, params);
      }
    ...
    onDeleteTap(id) {
      ...
      uni.showModal({
        ...
        success: async function (res) {
          if (res.confirm) {
            await _this.$api.del('xueshengxuanke', JSON.stringify([id]));
    ...
    async search() {
      ...
      if (this.searchForm.kechengleixing) {
        searchForm['kechengleixing'] = '%' + this.searchForm.kechengleixing + '%'
      }
      if (this.searchForm.jiaoshixingming) {
      ...
      let res = {};
      if (this.userid) {
        res = await this.$api.page(`xueshengxuanke`, searchForm);
      } else {
        res = await this.$api.list(`xueshengxuanke`, searchForm);
      }
      // 如果是第一页数据置空
