        ...
        <view
          ...
          <view
            ...
            <view
              ...
              <view
                  :style='{"padding":"0px","margin":"0px","color":"#666","textAlign":"left","flex":"1","width":"auto","lineHeight":"48rpx","fontSize":"28rpx"}'
                  class="text">{{detail.xuankeshijian}}
              </view>
            </view>
            ...
            <view
              ...
              <button
                  v-if="userid&&isAuth('xueshengxuanke','作业')"
                  ...
                  @tap="onAcrossTap('buzhizuoye','','','','')">作业
              </button>
              <button
                  v-if="!userid&&isAuthFront('xueshengxuanke','作业')"
                  :style='{"border":"0","padding":"0 20rpx","margin":"0 3% 20rpx 0","color":"#fff","borderRadius":"8rpx","background":"#0C77D5","width":"auto","fontSize":"28rpx","minWidth":"21%","lineHeight":"80rpx","height":"80rpx"}'
                  class="cu-btn bg-brown round shadow-blur"
                  @tap="onAcrossTap('buzhizuoye','','','','')">作业
              </button>
...
export default {
  ...
  async onShow(options) {
    ...
    if (crossCleanType) {
      ...
      res = await this.$api.info('xueshengxuanke', this.id);
  ...
  methods: {
    ...
    async init(type = 1) {
      ...
      let res = await this.$api.info('xueshengxuanke', this.id);
      this.detail = res.data;
      ...
      if (type == 2) {
        ...
        await this.$api.update('xueshengxuanke', this.detail)
      }
    },
