        ...
        <view
          ...
          <view
            ...
            <view
                ...
                class="detail-list-item">
              <image
                  v-if="detail.picture1"
                  :src="baseUrl+detail.picture1"
            ...
            <view
                ...
                class="detail-list-item">
              <image
                  v-if="detail.picture2"
                  :src="baseUrl+detail.picture2"
                  :style='{"width":"80rpx","borderRadius":"100%","objectFit":"cover","display":"block","height":"80rpx"}'></image>
            </view>
            <view
                :style='{"padding":"0 24rpx 24rpx","margin":"0 auto","borderColor":"#000","borderWidth":"0 2rpx","background":"#FFF7DF","display":"flex","width":"calc(100% - 48rpx)","borderStyle":"solid","height":"auto","order":"4"}'
                class="detail-list-item">
              <image
                  v-if="detail.picture3"
                  :src="baseUrl+detail.picture3"
                  :style='{"width":"80rpx","borderRadius":"100%","objectFit":"cover","display":"block","height":"80rpx"}'></image>
            </view>
...
export default {
  ...
  async onShow(options) {
    ...
    if (crossCleanType) {
      ...
      res = await this.$api.info('aboutus', this.id);
  ...
  methods: {
    ...
    async init(type = 1) {
      ...
      let res = await this.$api.info('aboutus', this.id);
      this.detail = res.data;
      ...
      if (type == 2) {
        ...
        await this.$api.update('aboutus', this.detail)
      }
    },
