<template>
  ...
  <mescroll-uni :down="downOption" :up="upOption" @down="downCallback" @init="mescrollInit" @up="upCallback">
    <view class="content">
        ...
        <view
          ...
          <view
            ...
            <text
                ...
                class="icon iconfont "></text>
            <input
                v-model="searchForm.kechengshipin"
                :style='{"border":"0","padding":"8rpx 20rpx 8rpx 20rpx","color":"#666","borderRadius":"0","background":"none","width":"100%","lineHeight":"80rpx","fontSize":"28rpx","height":"80rpx"}'
                placeholder="课程视频" type="text"></input>
          </view>
          <button
        ...
        <view
          ...
          <scroll-view
            ...
            <view v-for="(item,index) in categoryList" :key="index"
                  :class='categoryName === item.kechengleixing ? "active" : ""' class="tab"
                  @tap="categoryClick(item.kechengleixing)">
              {{ item.kechengleixing }}
            </view>
          </scroll-view>
          <!-- 样式1 -->
          <view
            ...
            <view v-for="(product,index) in list" :key="index"
              ...
              <view
                ...
                课程名称:{{ product.kechengmingcheng }}
              </view>
              <view
                  :style='{"padding":"4rpx 20rpx","overflow":"hidden","whiteSpace":"nowrap","color":"#333","width":"100%","lineHeight":"48rpx","fontSize":"28rpx","textOverflow":"ellipsis"}'
                  class="uni-product-title">
                {{ product.kechengleixing }}
              </view>
              <image
              ...
              <view
                ...
                <view
                    v-if="(userid && isAuth('kechengxinxi','修改')) || (!userid && isAuthFront('kechengxinxi','修改'))"
                    :data-row="product"
                ...
                <view
                    v-if="(userid && isAuth('kechengxinxi','删除')) || (!userid && isAuthFront('kechengxinxi','删除'))"
                    :data-row="product"
      ...
      <button
          v-if="userid && isAuth('kechengxinxi','新增')"
      ...
      <button
          v-if="!userid && isAuthFront('kechengxinxi','新增')"
          :style='{"border":"0","boxShadow":"none","color":"#fff","bottom":"120rpx","right":"120rpx","borderRadius":"100%","background":"#0C77D5","width":"80rpx","lineHeight":"80rpx","fontSize":"28rpx","position":"absolute","height":"80rpx","zIndex":"999"}'
          class="add-btn" @click="onAddTap()">新增
      </button>
    </view>
...
export default {
  ...
  methods: {
    ...
    async upCallback(mescroll) {
      ...
      if (this.searchForm.kechengshipin) {
    ...
    async search() {
      ...
      if (this.categoryName != '全部') {
        searchForm.kechengleixing = '%' + this.categoryName + '%'
      }
      if (this.searchForm.kechengshipin) {
        searchForm['kechengshipin'] = '%' + this.searchForm.kechengshipin + '%'
      }
      let res = {};
      if (this.userid) {
