        ...
        <view
          ...
          <view
            ...
            <view
              ...
              <view
                  :style='{"padding":"0px","margin":"0px","color":"#666","textAlign":"left","flex":"1","width":"auto","lineHeight":"48rpx","fontSize":"28rpx"}'
                  class="text">{{ detail.kechengleixing }}
              </view>
            </view>
            ...
            <view
                :style='{"padding":"24rpx 24rpx 48rpx","margin":"0 auto","borderColor":"#ccc","borderWidth":"0 0 0px 0","background":"#FFF7DF","display":"flex","width":"calc(100% - 0px)","borderStyle":"solid","height":"auto","order":"10"}'
                class="detail-list-item video">
              <video id="myVideo"
                     :src="baseUrl+detail.kechengshipin"
                     :style='{"border":"0","width":"100%","margin":"0","borderRadius":"16rpx","display":"block"}'
                     controls></video>
            </view>
            ...
            <view
              ...
              <button
                  v-if="userid&&isAuth('kechengxinxi','选课')"
                  ...
                  @tap="onAcrossTap('xueshengxuanke','','','','')">选课
              </button>
              <button
                  v-if="!userid&&isAuthFront('kechengxinxi','选课')"
                  :style='{"border":"0","padding":"0 20rpx","margin":"0 3% 20rpx 0","color":"#fff","borderRadius":"8rpx","background":"#0C77D5","width":"auto","fontSize":"28rpx","minWidth":"21%","lineHeight":"80rpx","height":"80rpx"}'
                  class="cu-btn bg-brown round shadow-blur"
                  @tap="onAcrossTap('xueshengxuanke','','','','')">选课
              </button>
  ...
  methods: {
    ...
    async init(type = 1) {
      ...
      if (type == 2) {
        ...
        await this.$api.update('kechengxinxi', this.detail)
      }
    },
