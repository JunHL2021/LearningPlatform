<template>
  ...
  <mescroll-uni :down="downOption" :up="upOption" @down="downCallback" @init="mescrollInit" @up="upCallback">
    <view class="content">
      <view
        ...
        <view
          ...
          <view
            ...
            <input
                v-model="searchForm.xueshengzhanghao"
                ...
                placeholder="学生账号" type="text"></input>
          </view>
          <view
              v-if="queryIndex==1"
              :style='{"margin":"0 0px","borderColor":"#ff9593","borderRadius":"0","flex":"1","background":"#fff","borderWidth":"0","lineHeight":"80rpx","position":"relative","borderStyle":"solid","height":"80rpx"}'
          ...
          <view
            ...
            <view v-for="(product,index) in list" :key="index"
              ...
              <view
                ...
                {{ product.xueshengxingming }}
              </view>
              <image
                  v-if="preHttp(product.touxiang)"
                  :src="product.touxiang.split(',')[0]"
              ...
              <image
                  v-else
                  :src="product.touxiang?baseUrl+product.touxiang.split(',')[0]:''"
                  :style='{"padding":"0","margin":"0","objectFit":"cover","borderRadius":"8rpx","display":"block","width":"100%","height":"200rpx","order":"-1"}'
                  class="uni-product-image"
                  mode="aspectFill"></image>
              ...
              <view
                ...
                <view v-if="(userid && isAuth('xuesheng','修改')) || (!userid && isAuthFront('xuesheng','修改'))"
                      :data-row="product"
                ...
                <view v-if="(userid && isAuth('xuesheng','删除')) || (!userid && isAuthFront('xuesheng','删除'))"
                      :data-row="product"
      ...
      <button
          v-if="userid && isAuth('xuesheng','新增')"
      ...
      <button
          v-if="!userid && isAuthFront('xuesheng','新增')"
          :style='{"border":"0","boxShadow":"none","color":"#fff","bottom":"120rpx","right":"120rpx","borderRadius":"100%","background":"#0C77D5","width":"80rpx","lineHeight":"80rpx","fontSize":"28rpx","position":"absolute","height":"80rpx","zIndex":"999"}'
          class="add-btn" @click="onAddTap()">新增
      </button>
    </view>
...
export default {
  ...
  methods: {
    ...
    async upCallback(mescroll) {
      ...
      if (this.searchForm.xueshengzhanghao) {
    ...
    onDeleteTap(id) {
      ...
      uni.showModal({
        ...
        success: async function (res) {
          if (res.confirm) {
            await _this.$api.del('xuesheng', JSON.stringify([id]));
    ...
    async search() {
      ...
      if (this.searchForm.xueshengzhanghao) {
        searchForm['xueshengzhanghao'] = '%' + this.searchForm.xueshengzhanghao + '%'
      }
      if (this.searchForm.xueshengxingming) {
