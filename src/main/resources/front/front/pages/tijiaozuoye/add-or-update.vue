    ...
    <view
      ...
      <form
        ...
        <view
          ...
          <input v-model="ruleForm.tijiaoshijian"
                 :disabled="ro.tijiaoshijian"
                 :style='{"border":"2rpx solid #fff","padding":"0px 24rpx","margin":"0px","color":"#666","borderRadius":"8rpx","flex":"1","background":"rgba(255,255,255,.6)","fontSize":"28rpx","height":"80rpx"}'
                 placeholder="提交时间" @tap="toggleTab('tijiaoshijian')"></input>
        </view>
        <view
            :style='{"padding":"0px 24rpx","margin":"0 0 24rpx 0","borderColor":"#7D7D7D","alignItems":"center","borderWidth":"0 0 2rpx","display":"flex","width":"100%","borderStyle":"solid","height":"auto"}'
            class="">
        ...
        <view
            :style='{"padding":"0px 24rpx","margin":"0 0 24rpx 0","borderColor":"#7D7D7D","alignItems":"center","borderWidth":"0 0 2rpx","display":"flex","width":"100%","borderStyle":"solid","height":"auto"}'
            class="" @tap="zuoyeneirongTap">
          <view
              :style='{"width":"auto","padding":"0 20rpx 0 0","lineHeight":"80rpx","fontSize":"28rpx","color":"#333","textAlign":"right"}'
              class="title">作业内容
          </view>
          <input
              v-if="ruleForm.zuoyeneirong"
              v-model="baseUrl+ruleForm.zuoyeneirong"
              :style='{"border":"2rpx solid #fff","padding":"0px 24rpx","margin":"0px","color":"#666","borderRadius":"8rpx","flex":"1","background":"rgba(255,255,255,.6)","fontSize":"28rpx","height":"80rpx"}'
              placeholder="作业内容"></input>
          <image v-else
                 :style='{"width":"80rpx","borderRadius":"100%","objectFit":"cover","display":"block","height":"80rpx"}'
                 class="avator" mode="aspectFill" src="../../static/gen/upload.png"></image>
        </view>
      ...
      <w-picker ref="tijiaoshijian" :current="false" :hasSecond="false" mode="dateTime" step="1"
                themeColor="#333333" @confirm="tijiaoshijianConfirm"></w-picker>
    </view>
  </view>
</template>
...
export default {
  ...
  async onLoad(options) {
    this.ruleForm.tijiaoshijian = this.$utils.getCurDateTime();
    ...
    if (options.id) {
      ...
      // 获取信息
      res = await this.$api.info(`tijiaozuoye`, this.ruleForm.id);
...
//跨表计算判断
      ...
      if (crossrefid && crossuserid) {
        ...
        let res = await this.$api.list(`tijiaozuoye`, params);
        if (res.data.total >= crossoptnum) {
          ...
          //跨表计算
          if (this.ruleForm.id) {
            await this.$api.update(`tijiaozuoye`, this.ruleForm);
          } else {
            await this.$api.add(`tijiaozuoye`, this.ruleForm);
          }
