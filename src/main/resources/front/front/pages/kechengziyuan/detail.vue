          ...
          <view
            ...
            <view
              ...
              <view
                  ...
                  class="text">{{detail.ziyuanmingcheng}}
              </view>
            </view>
            <view
                :style='{"padding":"4rpx 24rpx 8rpx","margin":"0 auto","borderColor":"#000","borderWidth":"0 2rpx","background":"#FFF7DF","display":"flex","width":"calc(100% - 48rpx)","borderStyle":"solid","height":"auto"}'
              ...
              <view
                  :style='{"padding":"0px","margin":"0px","color":"#666","textAlign":"left","flex":"1","width":"auto","lineHeight":"48rpx","fontSize":"28rpx"}'
                  class="text">{{detail.ziyuanleixing}}
              </view>
            </view>

            <view
                :style='{"padding":"4rpx 24rpx 8rpx","margin":"0 auto","borderColor":"#000","borderWidth":"0 2rpx","background":"#FFF7DF","display":"flex","width":"calc(100% - 48rpx)","borderStyle":"solid","height":"auto"}'
                class="detail-list-item" @tap="download(detail.ziyuanwenjian)">
              <view
                  :style='{"width":"auto","padding":"0 10rpx 0 0","lineHeight":"48rpx","fontSize":"28rpx","color":"#333","textAlign":"left"}'
                  class="lable">
                资源文件：
            ...
            <view
              ...
              <view
                  ...
                  class="rich-text">
                <rich-text :nodes="detail.ziyuanjieshao"></rich-text>
              </view>
            </view>
...
export default {
  ...
  async onShow(options) {
    ...
    if (crossCleanType) {
      ...
      res = await this.$api.info('kechengziyuan', this.id);
  ...
  methods: {
        ...
        uni.showModal({
          ...
          success: async function (res) {
            if (res.confirm) {
              ...
              await _this.$api.update('kechengziyuan', _this.detail)
    ...
    async init(type = 1) {
      ...
      let res = await this.$api.info('kechengziyuan', this.id);
      this.detail = res.data;
      ...
      //修改富文本的图片样式
      this.detail.ziyuanjieshao = this.detail.ziyuanjieshao.replace(/img src/gi, "img style=\"width:100%;\" src");
      if (type == 2) {
        this.detail.discussnum++
        await this.$api.update('kechengziyuan', this.detail)
      }
    },
