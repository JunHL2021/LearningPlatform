  ...
  <view class="container">
    <view class="page-body">
      <view class='wrapper'>
        ...
        <editor id="editor" :placeholder="placeholder" :read-only="readOnly" class="ql-container" showImgResize
                showImgSize showImgToolbar @input="editText" @ready="onEditorReady"
