  ...
  <view class="uni-calendar" @mouseleave="leaveCale">
    ...
    <view v-if="insert || show"
      ...
      <view class="uni-calendar__box">
        ...
        <view v-for="(item,weekIndex) in weeks" :key="weekIndex" class="uni-calendar__weeks">
          <view v-for="(weeks,weeksIndex) in item" :key="weeksIndex" class="uni-calendar__weeks-item">
            <calendar-item :calendar="calendar" :checkHover="range" :selected="selected"
                           :weeks="weeks" class="uni-calendar-item--hook" @change="choiceDate"
      ...
      <view v-if="!insert && !range && hasTime" class="uni-date-changed uni-calendar--fixed-top"
        ...
        <time-picker v-model="time" :border="false" :disabled="!tempSingleDate" :end="timepickerEndTime"
                     :hide-second="hideSecond" :start="timepickerStartTime" class="time-picker-style" type="time">
        </time-picker>
      </view>
      ...
      <view v-if="!insert && range && hasTime" class="uni-date-changed uni-calendar--fixed-top">
        <view class="uni-date-changed--time-start">
          ...
          <time-picker v-model="timeRange.startTime" :border="false" :disabled="!tempRange.before"
                       ...
                       :start="timepickerStartTime" class="time-picker-style" type="time">
          </time-picker>
        </view>
        <view style="line-height: 50px;">
          <uni-icons color="#999" type="arrowthinright"></uni-icons>
        </view>
        <view class="uni-date-changed--time-end">
          <view class="uni-date-changed--time-date">{{tempRange.after ? tempRange.after : endDateText}}</view>
          <time-picker v-model="timeRange.endTime" :border="false" :disabled="!tempRange.after" :end="timepickerEndTime"
