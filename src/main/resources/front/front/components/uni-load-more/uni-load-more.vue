<template>
  <view class="uni-load-more" @click="onClick">
    ...
    <svg
      ...
      <circle :stroke-width="3" :style="{color:color}" cx="50" cy="50" fill="none" r="20"></circle>
    </svg>
    <!-- #endif -->
    <!-- #ifndef APP-NVUE || H5 -->
    <view
