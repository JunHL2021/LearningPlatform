<template>
  <view class="w-picker">
    <view :class="{'show':showPicker}" catchtouchmove="true" class="mask" @tap="maskTap" @touchmove.stop.prevent></view>
    <view :class="{'show':showPicker}" class="w-picker-cnt">
      <view catchtouchmove="true" class="w-picker-hd" @touchmove.stop.prevent>
        <view class="w-picker-btn" @tap="pickerCancel">取消</view>
        <view :style="{'color':themeColor}" class="w-picker-btn" @tap="pickerConfirm">确定</view>
      </view>
      <view v-if="mode=='linkage'" class="w-picker-view">
        <picker-view :indicator-style="itemHeight" :value="pickVal" @change="bindChange" @touchend="touchEnd"
                     @touchstart="touchStart">
          <picker-view-column v-for="(col,colIndex) in data" :key="colIndex">
            <view v-for="(item,index) in col" :key="index" class="w-picker-item">{{ item.label }}</view>
          </picker-view-column>
        </picker-view>
      </view>
      <view v-if="mode=='half'" class="w-picker-view">
        <picker-view :indicator-style="itemHeight" :value="pickVal" @change="bindChange" @touchend="touchEnd"
                     @touchstart="touchStart">
          <picker-view-column>
            <view v-for="(item,index) in data.years" :key="index" class="w-picker-item">{{ item }}年</view>
          </picker-view-column>
          <picker-view-column>
            <view v-for="(item,index) in data.months" :key="index" class="w-picker-item">{{ item }}月</view>
          </picker-view-column>
          <picker-view-column>
            <view v-for="(item,index) in data.days" :key="index" class="w-picker-item">{{ item }}日</view>
          </picker-view-column>
          <picker-view-column>
            <view v-for="(item,index) in data.areas" :key="index" class="w-picker-item">{{ item.label }}</view>
          </picker-view-column>
        </picker-view>
      </view>
      <view v-if="mode=='date'" class="w-picker-view">
        <picker-view :indicator-style="itemHeight" :value="pickVal" @change="bindChange" @touchend="touchEnd"
                     @touchstart="touchStart">
          <picker-view-column>
            <view v-for="(item,index) in data.years" :key="index" class="w-picker-item">{{ item }}年</view>
      ...
      <view v-if="mode=='yearMonth'" class="w-picker-view">
        <picker-view :indicator-style="itemHeight" :value="pickVal" @change="bindChange" @touchend="touchEnd"
                     @touchstart="touchStart">
          <picker-view-column>
            <view v-for="(item,index) in data.years" :key="index" class="w-picker-item">{{ item }}年</view>
      ...
      <view v-if="mode=='dateTime'" class="w-picker-view">
        <picker-view :indicator-style="itemHeight" :value="pickVal" @change="bindChange" @touchend="touchEnd"
                     @touchstart="touchStart">
          <picker-view-column>
            <view v-for="(item,index) in data.years" :key="index" class="w-picker-item">{{ item }}年</view>
          ...
          <picker-view-column>
            <view v-for="(item,index) in data.hours" :key="index" class="w-picker-item">{{ item }}时</view>
          </picker-view-column>
          <picker-view-column>
            <view v-for="(item,index) in data.minutes" :key="index" class="w-picker-item">{{ item }}分</view>
          </picker-view-column>
          <picker-view-column>
            <view v-for="(item,index) in data.seconds" :key="index" class="w-picker-item">{{ item }}秒</view>
          </picker-view-column>
        </picker-view>
      </view>
      <view v-if="mode=='range'" class="w-picker-view">
        <picker-view :indicator-style="itemHeight" :value="pickVal" @change="bindChange" @touchend="touchEnd"
                     @touchstart="touchStart">
          <picker-view-column>
            <view v-for="(item,index) in data.fyears" :key="index" class="w-picker-item">{{ item }}</view>
          </picker-view-column>
          <picker-view-column>
            <view v-for="(item,index) in data.fmonths" :key="index" class="w-picker-item">{{ item }}</view>
          </picker-view-column>
          <picker-view-column>
            <view v-for="(item,index) in data.fdays" :key="index" class="w-picker-item">{{ item }}</view>
          </picker-view-column>
          <picker-view-column>
            <view class="w-picker-item">-</view>
          </picker-view-column>
          <picker-view-column>
            <view v-for="(item,index) in data.tyears" :key="index" class="w-picker-item">{{ item }}</view>
          </picker-view-column>
          <picker-view-column>
            <view v-for="(item,index) in data.tmonths" :key="index" class="w-picker-item">{{ item }}</view>
          </picker-view-column>
          <picker-view-column>
            <view v-for="(item,index) in data.tdays" :key="index" class="w-picker-item">{{ item }}</view>
          </picker-view-column>
        </picker-view>
      </view>
      <view v-if="mode=='time'" class="w-picker-view">
        <picker-view :indicator-style="itemHeight" :value="pickVal" @change="bindChange" @touchend="touchEnd"
                     @touchstart="touchStart">
          <picker-view-column>
            <view v-for="(item,index) in data.hours" :key="index" class="w-picker-item">{{ item }}时</view>
      ...
      <view v-if="mode=='region'" class="w-picker-view">
        <picker-view :indicator-style="itemHeight" :value="pickVal" @change="bindChange" @touchend="touchEnd"
                     @touchstart="touchStart">
          <picker-view-column>
            <view v-for="(item,index) in data.provinces" :key="index" class="w-picker-item">{{ item.label }}</view>
          </picker-view-column>
          <picker-view-column>
            <view v-for="(item,index) in data.citys" :key="index" class="w-picker-item">{{ item.label }}</view>
          </picker-view-column>
      ...
      <view v-if="mode=='selector'" class="w-picker-view">
        <picker-view :indicator-style="itemHeight" :value="pickVal" @change="bindChange" @touchend="touchEnd"
                     @touchstart="touchStart">
          <picker-view-column>
            <view v-for="(item,index) in data" :key="index" class="w-picker-item">{{ item.label }}</view>
          </picker-view-column>
        </picker-view>
      </view>
      <view v-if="mode=='limit'" class="w-picker-view">
        <picker-view :indicator-style="itemHeight" :value="pickVal" @change="bindChange" @touchend="touchEnd"
                     @touchstart="touchStart">
          <picker-view-column>
            <view v-for="(item,index) in data.date" :key="index" class="w-picker-item">{{ item.label }}</view>
          </picker-view-column>
          <picker-view-column>
            <view v-for="(item,index) in data.hours" :key="index" class="w-picker-item">{{ item.label }}时</view>
          </picker-view-column>
          <picker-view-column>
            <view v-for="(item,index) in data.minutes" :key="index" class="w-picker-item">{{ item.label }}分</view>
          </picker-view-column>
        </picker-view>
      </view>
      <view v-if="mode=='limitHour'" class="w-picker-view">
        <picker-view :indicator-style="itemHeight" :value="pickVal" @change="bindChange" @touchend="touchEnd"
                     @touchstart="touchStart">
          <picker-view-column>
            <view v-for="(item,index) in data.date" :key="index" class="w-picker-item">{{ item.label }}</view>
