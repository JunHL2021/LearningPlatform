<template>
  <view v-if="show" :style="{ backgroundColor: backgroundColor }" class="uni-noticebar" @click="onClick">
    <!-- #ifdef MP-ALIPAY -->
    <view v-if="showClose === true || showClose === 'true'" class="uni-noticebar-close" @click="close">
      <uni-icons :color="color" size="12" type="closefill"/>
    </view>
    <view v-if="showIcon === true || showIcon === 'true'" class="uni-noticebar-icon">
      <uni-icons :color="color" size="14" type="sound"/>
    </view>
    <!-- #endif -->
    <!-- #ifndef MP-ALIPAY -->
    <uni-icons v-if="showClose === true || showClose === 'true'" :color="color" class="uni-noticebar-close"
               size="12"
               type="closefill" @click="close"/>
    <uni-icons v-if="showIcon === true || showIcon === 'true'" :color="color" class="uni-noticebar-icon" size="14"
               type="sound"/>
    <!-- #endif -->
    <view ref="textBox"
    ...
    <view v-if="showGetMore === true || showGetMore === 'true'" class="uni-noticebar__more" @click="clickMore">
      ...
      <uni-icons :color="moreColor" size="14" type="arrowright"/>
    </view>
  </view>
</template>
