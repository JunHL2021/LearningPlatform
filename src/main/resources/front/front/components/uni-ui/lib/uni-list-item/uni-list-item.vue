<template>
  ...
  <cell>
    ...
    <view :class="disabled ? 'uni-list-item--disabled' : ''"
      ...
      <view :class="{'uni-list-item--first':isFirstChild}" class="uni-list-item__container">
        ...
        <view v-if="showBadge || showArrow || showSwitch" class="uni-list-item__extra">
          ...
          <switch v-if="showSwitch" :checked="switchChecked" :disabled="disabled" @change="onSwitchChange"/>
