<template>
  ...
  <view :class="['swiper-slide',slideClass]" :style="[itemStyle,customStyle]" @click.stop="onClickSlide">
    ...
    <view :change:swiperItemTransform="zSwiperWxs.wxsItemTransformObserver" :class="['swiper-slide',slideClass]"
          :style="[itemStyle,customStyle]"
          :swiperItemTransform="wxsItemTransform" @click.stop="onClickSlide">
      <!-- #endif -->
      <slot></slot>
    </view>
</template>
...
<!-- #endif -->
<script>
import {ChildrenMixin} from '../../libs/mixins/relation.js';
