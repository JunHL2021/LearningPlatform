<template>
  <view class="progress_box">
    <canvas :style="{width:progress_width+'px',height:progress_height+'px'}" canvas-id="cpbg"
            class="progress_bg"></canvas>
    <canvas :style="{width:progress_width+'px',height:progress_height+'px'}" canvas-id="cpbar"
            class="progress_bar"></canvas>
  </view>
</template>
<script>
/**
